...
//		Client c = new Client("Istvan", address, 0755225454, bankAccount);
//
...
//
//		Car car1 = // select from stock the car you like
//
//		compexit.sellCarToClient(car1, c);
//
//		ClientAccount clientAccount = compexit.getAccount(c);
//
...
//
//		compexit.buyCarFromClient(oldestCar, c, carPrice);
//
